# Generated by Django 4.2.11 on 2025-08-17 14:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idgrupo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sysvar_app.grupo')),
                ('idsubgrupo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sysvar_app.subgrupo')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['codigodebarra'], name='sysvar_app__codigod_8080cc_idx'), models.Index(fields=['codigoproduto'], name='sysvar_app__codigop_e8b39d_idx')],
            },
        ),
        ...
        migrations.AddConstraint(
            model_name='grupodetalhe',
            constraint=models.UniqueConstraint(fields=('idgrupo', 'idsubgrupo'), name='uq_grupodetalhe_grupo_subgrupo'),
        ),
        migrations.AddIndex(
            model_name='estoque',
